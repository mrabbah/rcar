...
.z-combobox-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/combobox-rounded-l.gif')});
}
.z-bandbox-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/bandbox-rounded-l.gif')});
}
.z-datebox-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/datebox-rounded-l.gif')});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/timebox-rounded-l.gif')});
}
...
.z-spinner-rounded input.z-spinner-rounded-text-invalid {
	background: #FFF url(${c:encodeURL('/images/skin/component/redcombo-rounded-l.gif')}) repeat-x 0 0;
}
...
.z-spinner-rounded .z-spinner-rounded-text-invalid + i.z-spinner-rounded-btn-right-edge {
	background-image: url(${c:encodeURL('/images/skin/component/redcombo-rounded-l.gif')});
