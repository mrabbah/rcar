...
.z-combobox-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/combobox-rounded-s.gif')});
}
.z-bandbox-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/bandbox-rounded-s.gif')});
}
.z-datebox-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/datebox-rounded-s.gif')});
}
.z-timebox-rounded-inp,
.z-spinner-rounded-inp {
	background-image: url(${c:encodeURL('/images/skin/component/timebox-rounded-s.gif')});
}
...
.z-spinner-rounded input.z-spinner-rounded-text-invalid {
	background: #FFF url(${c:encodeURL('/images/skin/component/redcombo-rounded-s.gif')}) repeat-x 0 0;
}
...
.z-spinner-rounded .z-spinner-rounded-text-invalid + i.z-spinner-rounded-btn-right-edge {
	background-image: url(${c:encodeURL('/images/skin/component/redcombo-rounded-s.gif')});
